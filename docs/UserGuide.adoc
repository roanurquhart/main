...
* `addcpny n/Money Inc p/98765432 e/money@example.com a/John street, block 123, #01-01`
* `addcpny n/Big Money e/bmoney@example.com a/Newgate Rd p/1234567 t/Fortune500`
...
=== Add to favorite list: `delFav`

Removes a person to the  “favorite” list

Format: `delFav` [NAME]

=== Add to favorite list: `listFav`
