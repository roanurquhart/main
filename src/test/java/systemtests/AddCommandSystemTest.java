...
public class AddCommandSystemTest extends AddressBookSystemTest {
    ...
    public void add() {
        ...
        String command = "   " + AddCommand.COMMAND_WORD + "  " + NAME_DESC_AMY + "  " + PHONE_DESC_AMY + " "
                + EMAIL_DESC_AMY + "   " + ADDRESS_DESC_AMY + "   " + SALARY_DESC_AMY + "   " + OCCUPATION_DESC_AMY + "   "
                + RELATIONSHIP_DESC_AMY + "   " + TAG_DESC_FRIEND + " ";
        ...
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + INVALID_SALARY_DESC + OCCUPATION_DESC_AMY + RELATIONSHIP_DESC_AMY;
        assertCommandFailure(command, Salary.MESSAGE_CONSTRAINTS);

        /* Case: invalid occupation -> rejected */
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + SALARY_DESC_AMY + INVALID_OCCUPATION_DESC + RELATIONSHIP_DESC_AMY;
        assertCommandFailure(command, Occupation.MESSAGE_CONSTRAINTS);

        /* Case: invalid relationship -> rejected */
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + SALARY_DESC_AMY + OCCUPATION_DESC_AMY + INVALID_RELATIONSHIP_DESC;
        assertCommandFailure(command, Relationship.MESSAGE_CONSTRAINTS);
