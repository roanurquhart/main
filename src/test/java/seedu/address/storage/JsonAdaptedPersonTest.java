...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, null, VALID_EMAIL, VALID_ADDRESS,
                VALID_SALARY, VALID_OCCUPATION, VALID_RELATIONSHIP, VALID_TAGS);
    ...
    public void toModelType_nullSalary_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                null, VALID_OCCUPATION, VALID_RELATIONSHIP, VALID_TAGS);
    ...
    public void toModelType_nullOccupation_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_SALARY, null, VALID_RELATIONSHIP, VALID_TAGS);
    ...
    public void toModelType_nullRelationship_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_SALARY, VALID_OCCUPATION, null, VALID_TAGS);
