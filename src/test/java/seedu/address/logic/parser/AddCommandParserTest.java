...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + SALARY_DESC_BOB + OCCUPATION_DESC_BOB + RELATIONSHIP_DESC_BOB
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_AMY + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + SALARY_DESC_BOB + OCCUPATION_DESC_BOB + RELATIONSHIP_DESC_BOB
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + SALARY_DESC_AMY + SALARY_DESC_BOB + OCCUPATION_DESC_BOB + RELATIONSHIP_DESC_BOB
                + TAG_DESC_FRIEND, new AddCommand(expectedPerson));

        // multiple occupations - last occupation accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + OCCUPATION_DESC_AMY + OCCUPATION_DESC_BOB + OCCUPATION_DESC_BOB
                + RELATIONSHIP_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedPerson));

        // multiple relationships - last relationship accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + SALARY_DESC_BOB + OCCUPATION_DESC_BOB + RELATIONSHIP_DESC_AMY
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                        + SALARY_DESC_AMY + OCCUPATION_DESC_AMY + RELATIONSHIP_DESC_AMY,
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + VALID_SALARY_BOB + OCCUPATION_DESC_BOB + RELATIONSHIP_DESC_BOB,
                expectedMessage);

        // missing occupation prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + SALARY_DESC_BOB + VALID_OCCUPATION_BOB + RELATIONSHIP_DESC_BOB,
                expectedMessage);

        // missing relationship prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + SALARY_DESC_BOB + OCCUPATION_DESC_BOB + VALID_RELATIONSHIP_BOB,
                expectedMessage);
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid salary
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC
                + INVALID_SALARY_DESC + OCCUPATION_DESC_BOB + RELATIONSHIP_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Address.MESSAGE_CONSTRAINTS);

        // invalid occupation
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC
                + SALARY_DESC_BOB + INVALID_OCCUPATION_DESC + RELATIONSHIP_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Address.MESSAGE_CONSTRAINTS);

        // invalid relationship
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC
                + SALARY_DESC_BOB + OCCUPATION_DESC_BOB + INVALID_RELATIONSHIP_DESC
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Address.MESSAGE_CONSTRAINTS);
