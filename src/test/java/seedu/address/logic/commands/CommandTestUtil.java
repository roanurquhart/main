...
public class CommandTestUtil {
    ...
    public static final String VALID_SALARY_BOB = "4500";
    ...
    public static final String INVALID_SALARY_DESC = " " + PREFIX_SALARY + "&"; // '&' not allowed in salary
    public static final String INVALID_OCCUPATION_DESC = " " + PREFIX_OCCUPATION;
    // empty string not allowed for occupation
     ...
     * - {@code actualCommandHistory} remains unchanged.
     */
    public static void assertCommandFailureFavorite(Command command, Model actualModel, CommandHistory actualCommandHistory,
                                            String expectedMessage) {
        // we are unable to defensively copy the model for comparison later, so we can
        // only do so by copying its components.
        AddressBook expectedAddressBook = new AddressBook(actualModel.getAddressBook());
        List<Person> expectedFilteredList = new ArrayList<>(actualModel.getFavoritesList());
        Person expectedSelectedPerson = actualModel.getSelectedPerson();
